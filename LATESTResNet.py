...
class ResNet(nn.Module):
    ...
    def __init__(self, game, num_resBlocks, num_hidden, device):
        ...
        self.policyHead = nn.Sequential(
            ...
            nn.Linear(32 * game.row_count * game.column_count, 2*game.number_of_edges)
            # POLICY HEAD INFORMA SOLO SU META'
    ...
    def forward(self, x):
        ...
        #print(f"policy from the NN: {policy}")
        value = self.valueHead(x)
        #print(f"value from the NN: {value}")
