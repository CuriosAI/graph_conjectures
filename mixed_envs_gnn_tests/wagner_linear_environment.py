...
class WagnerLinearEnvironment(gym.Env):
    ...
    def step(self, action):
        ...
        # if not nx.is_forest(self.nxgraph):
        ...
        #     # return np.concatenate((self.graph, self.timestep)), self.last_reward, self.done, False, {}
        #     self.graph[edge_index] = 1-self.graph[edge_index]        
        #     self.nxgraph = self.compute_nx_graph()
