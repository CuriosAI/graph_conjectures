...
""" This document contains:
    - the GIN and GCN models used in the paper
    - the policy_layers used to predict policies after feature extraction
      (done with GIN or other customizable nets)
    - the action_predictor architecture, that combined a given feature extractor to policy_layers
"""
