...
def a2c_run(number_of_nodes):
    ...
    unique_folder = create_experiment_folder("A2C", number_of_nodes)

    # Create the A2C agent. net_arch = [128, 64, 4] is Wagner choice.
    net_arch = [128, 64, 4] # To be tuned
    model = A2C('MlpPolicy', train_env, verbose=1, policy_kwargs={"net_arch": net_arch}, tensorboard_log=f"./{unique_folder}/tensorboard/")
